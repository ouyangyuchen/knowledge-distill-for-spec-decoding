...
run_command+=" VLLM_REQUEST_BATCH_SIZE=$(quote "${VLLM_REQUEST_BATCH_SIZE}")"
run_command+=" VLLM_MAX_MODEL_LEN=$(quote "${VLLM_MAX_MODEL_LEN}")"
run_command+=" VLLM_GPU_MEMORY_UTILIZATION=$(quote "${VLLM_GPU_MEMORY_UTILIZATION}")"
run_command+=" VLLM_MAX_NUM_SEQS=$(quote "${VLLM_MAX_NUM_SEQS}")"
run_command+=" VLLM_DISABLE_LOG_STATS=$(quote "${VLLM_DISABLE_LOG_STATS}")"
